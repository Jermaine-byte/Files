...
if (isset($_POST['submit']))
{
    ...
    if (strlen($voornaam) == 0 || strlen($achternaam) == 0 || strlen($email) == 0 || strlen($adres) == 0 || strlen($bankgegevens) == 0 || strlen($geslacht) == 0 || strlen($geboortedatum) == 0 || strlen($wachtwoord) == 0)
    {
        ?>
        <script>
        ...
        $query = "INSERT INTO `inlog` (`id`, `voornaam`, `achternaam`, `email`, `wachtwoord`, `spelerNummer`, `adres`, `bankgegevens`, `geslacht`, `startLidmaatschap`, `geboortedatum`) VALUES (NULL, '$voornaam', '$achternaam', '$email', '$wachtwoord', '$spelernummer', '$adres', '$bankgegevens', '$geslacht', '$today', '$geboortedatum')";
            ...
            <div class="card-body">
                <form class="px-4 py-3" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="email" placeholder="peterkroos@gmail.com" value="<?php echo $email; ?>">
                        <label for="e">Adres:</label>
                        <input type="text" name="adres" class="form-control" id="adres" placeholder="Vogellaan 45" value="<?php echo $adres; ?>">
