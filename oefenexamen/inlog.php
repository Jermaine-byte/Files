        ...
        <div class="card">
            <div class="card-body">
                <form class="px-4 py-3" method="post">
                    <p><b><i>Inloggen als docent of student</i></b></p>
                    ...
                    <hr>
                    <p><b><i>Nog geen account? Registreer hier</i></b></p>
                    <button type="button" name="registeer" onclick="window.location.href='aanmeld.php'">Registreren</button>
                </form>
            </div>
        </div>
    </div>
